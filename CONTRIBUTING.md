...
**End-to-end, with Playwright.** `npm run e2e` in `Frontend/` — currently 389 checks across
...
**Unit tests, with Vitest.** `npm test` in either package — 67 checks in `Frontend/`, 72 in
